...
Atuo como desenvolvedora de desenvolvimento de software na Autaza, uma empresa especializada em soluções de visão computacional e inteligência artificial aplicadas à indústria. Nessa função, colaboro em projetos que envolvem desde o desenvolvimento de aplicações backend e frontend até a integração com modelos de IA para inspeção automatizada de qualidade.
    </p>
    </ol>
    <ol start="2"> 
    <h3><li><b>Experiências</b></li></h3>
      <p align="justify">
        <ul>
          <li><b>Desenvolvedora de Software | Dez/2024 - Atual | <a href="https://www.autaza.com/">Autaza</a></b></li>
            <ul>
